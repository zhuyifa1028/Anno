...
(function($, document) {
	...
	var domBuffer = '<div class="mui-dtpicker" data-type="datetime">\
		<div class="mui-dtpicker-header f-s-14 h-90 l-h-d-90 p-a-15">\
			<button data-id="btn-cancel" class="mui-btn ft-999999 f-s-12 h-60 l-h-d-60 p-a-0 w-90">取消</button>\
			<button data-id="btn-ok" class="mui-btn bg-2cad6e ft-ffffff f-s-12 h-60 l-h-d-60 p-a-0 w-90">确定</button>\
		</div>\
		<div class="mui-dtpicker-title"><h5 class="f-s-14 h-75 l-h-d-75 p-a-0" data-id="title-y">年</h5><h5 class="f-s-14 h-75 l-h-d-75 p-a-0" data-id="title-m">月</h5><h5 class="f-s-14 h-75 l-h-d-75 p-a-0" data-id="title-d">日</h5><h5 class="f-s-14 h-75 l-h-d-75 p-a-0" data-id="title-h">时</h5><h5 class="f-s-14 h-75 l-h-d-75 p-a-0" data-id="title-i">分</h5></div>\
		<div class="mui-dtpicker-body h-375">\
	...
	var DtPicker = $.DtPicker = $.Class.extend({
		...
		_create: function(options) {
			...
			ui.picker.style.webkitTransform = "translateY(" + (parseInt(ui.picker.offsetHeight) + 10) + "px)";
			//生成
			self._createYear();
			self._createMonth();
			self._createDay();
