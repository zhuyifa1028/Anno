							...
							<div class="ibox-content">
								<form class="form" action="${admin }/rental/edit/10" method="post" novalidate="novalidate">
									...
									<div class="form-group" role="form">
										<label>邮箱</label>
										<input type="input" name="email" placeholder="请输入邮箱" class="form-control" value="${model.userEmail }"  />
									</div>
									<div class="form-group" role="form">
										<label>行政名称</label>
										<input type="text" name="admin" placeholder="请输入行政名称" class="form-control" value="${model.userAdmin }" />
									</div>
									<div class="form-group" role="form">
										<label>标题</label>
										<input type="text" name="" placeholder="请输入标题" class="form-control" value="" />
									</div>
									...
									<div class="form-group">
										...
										<select name="isdisplay" id="recordIsDisplay" class="form-control" data-search="true">
												...
												<c:forEach items="${USER_IS_DISPLAY}" var="m">
													<option value="${m.key }" <c:if test="${model.userIsdisplay eq m.key }">selected="selected"</c:if>>${m.value }</option>
												</c:forEach>
										</select>
								   </div>
