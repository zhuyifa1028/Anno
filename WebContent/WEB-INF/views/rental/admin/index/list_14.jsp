							...
							<div class="ibox">
								...
								<div class="ibox-content m-b-sm border-bottom">
									...
									<div class="row">
										...
										<div class="col-sm-4">
											<div class="form-group">
												<label class="control-label" for="title">加油日期自</label>
												<div class="input-group date">
													<span class="input-group-addon"><i
														class="fa fa-calendar"></i></span> <input type="text"
														name="ge_date" id="ge_date" placeholder="加油日期自"
														class="form-control"
										...
										<div class="ibox-title">
											...
											<div class="ibox-tools">
												...
												<ul class="dropdown-menu dropdown-user">
													<li><a href="../list/125.html?mid=14&driverName=${params.driverName }&driverId=${params.driverId }&driverCarnum=${params.driverCarnum }&ge_date=${params.ge_date }&le_date=${params.le_date }">导出</a></li>
												</ul>
												<script type="text/javascript">
													$(function() {
											...
											<table class="footable table table-stripped toggle-arrow-tiny">
												<thead>
													<tr>
														...
														<th data-sort-ignore="true">当前码表公里数</th>
														<th data-sort-ignore="true">油卡/现金</th>
														<th data-sort-ignore="true">加油日期及时间</th>
													...
													<c:forEach items="${models }" var="m">
														<tr>
															...
															<td>
																...
																<c:if test="${empty m.driverGasrpaytype }">-</c:if>
															</td>
