					...
					<div class="col-lg-12 animated fadeInRight">
						<div class="ibox float-e-margins">
							...
							<div class="ibox-content">
								<form class="form" action="${admin }/rental/edit/13" method="post" novalidate="novalidate">
									...
									<div class="form-group" role="form">
										<label>司机出发时路码</label>
										<fmt:formatNumber value="${model.driverLeavemile}" var="result" pattern="0" groupingUsed="false"/>
										<input type="number" name="leavemile" placeholder="请输入司机出发时路码" class="form-control" value="${result}" />
									</div>
									<div class="form-group" role="form">
										<label>司机出发时时间</label>
										<div class="input-group date">
											<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
											<input type="text" name="leavedate" id="edate" placeholder="司机出发时时间" class="form-control input-date" value="<fmt:formatDate value="${model.driverLeavedate }" pattern="yyyy-MM-dd HH:mm:ss" />" />
										</div>
										<label class="error" for="edate"></label>
									</div>
									<div class="form-group" role="form">
										<label>用户上车路码</label>
										<fmt:formatNumber value="${model.driverLeavemileuser}" var="result" pattern="0" groupingUsed="false"/>
										<input type="number" name="leavemileuser" placeholder="用户上车路码" class="form-control" value="${result}"/>
									</div>
									<div class="form-group" role="form">
										<label>用户上车时间</label>
										<div class="input-group date">
											<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
											<input type="text" name="leavedateuser" id="edate" placeholder="请输入用户上车时间" class="form-control input-date" value="<fmt:formatDate value="${model.driverLeavedateuser }" pattern="yyyy-MM-dd HH:mm:ss" />" />
										</div>
										<label class="error" for="edate"></label>
									</div>
									<div class="form-group" role="form">
										<label>用户下车路码</label>
										<fmt:formatNumber value="${model.driverBackmileuser}" var="result" pattern="0" groupingUsed="false"/>
										<input type="number" name="backmileuser" placeholder="请输入用户下车路码" class="form-control" value="${result}" />
									</div>
									<div class="form-group" role="form">
										<label>用户下车时间</label>
										<div class="input-group date">
											<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
											<input type="text" name="backdateuser" id="edate" placeholder="请输入用户下车时间" class="form-control input-date" value="<fmt:formatDate value="${model.driverBackdateuser }" pattern="yyyy-MM-dd HH:mm:ss" />" />
										</div>
										<label class="error" for="edate"></label>
									</div>
									<div class="form-group" role="form">
										<label>司机回家路码</label>
										<fmt:formatNumber value="${model.driverBackmile }" var="result" pattern="0" groupingUsed="false"/>
										<input type="number" name="backmile" placeholder="请输入司机回家路码" class="form-control" value="${result }" />
									</div>
									<div class="form-group" role="form">
										<label>司机回家时间</label>
										<div class="input-group date">
											<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
											<input type="text" name="backdate" id="edate" placeholder="请输入司机回家时间" class="form-control input-date" value="<fmt:formatDate value="${model.driverBackdate }" pattern="yyyy-MM-dd HH:mm:ss" />" />
										</div>
										<label class="error" for="edate"></label>
									</div>
									<div class="form-group" role="form">
										<label>公里数</label>
										<fmt:formatNumber value="${model.driverMilenow }" var="result" pattern="0" groupingUsed="false"/>
										<input type="number" name="milenow" placeholder="请输入公里数" class="form-control" value="${result }" />
									</div>
									...
									<div class="form-group" role="form">
										...
										<div class="input-group date">
											<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
											<input type="text" name="date" id="edate" placeholder="请输入日志时间" class="form-control input-date" value="<fmt:formatDate value="${model.driverDate }" pattern="yyyy-MM-dd" />" />
										</div>
										<label class="error" for="edate"></label>
									</div>
