									...
									<div class="row">
										...
										<div class="col-sm-4">
											<div class="form-group">
												...
												<input type="text" id="tel" name="userTel" placeholder="电话号码" class="form-control" value="${params.userTel }" data-search="true" />
											</div>
										</div>
										
										<div class="col-sm-4">
											<div class="form-group">
												<label class="control-label" for="userName">用车人姓名</label>
												<input type="text" id="name" name="userName" placeholder="用车人姓名" class="form-control" value="${params.userName }" data-search="true" />
											</div>
										</div>
										...
										<div class="col-sm-4">
											<div class="form-group">
												...
												<select name="userState" id="userState" class="form-control" data-search="true">
													<option value="">--请选择--</option>
													<c:forEach items="${USER_STATE}" var="m">
														<option value="${m.key }" <c:if test="${params.userState eq m.key }">selected="selected"</c:if>>${m.value }</option>
													</c:forEach>
												</select>
											</div>
										</div>
										...
										<div class="col-sm-4">
											<div class="form-group">
												<label class="control-label" for="userCompany">公司名称 </label>
												<input type="text" id="company" name="userCompany" placeholder="公司名称" class="form-control" value="${params.userCompany }" data-search="true" />
											</div>
										</div>
										...
										<div class="ibox-title">
											...
											<div class="ibox-tools">
												...
												<ul class="dropdown-menu dropdown-user">
													...
													<%-- <li><a href="javascript:;" data-pid="0" data-action="${admin_science }/edit/100.html?mid=${params.mid }">导入</a></li> --%>
												</ul>
												<script type="text/javascript">
													$(function() {
												...
												<tbody>
													<c:forEach items="${models }" var="m">
														<tr>
															...
															<td>
																<c:if test="${ m.userState eq 0}">启用</c:if>
																<c:if test="${ m.userState eq 1}">禁用</c:if>
																<c:if test="${empty m.userState }">-</c:if>
															</td>
															<td>
