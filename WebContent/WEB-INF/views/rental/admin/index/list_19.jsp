									...
									<div class="row">
										<div class="col-sm-4">
											<div class="form-group">
												<label class="control-label" for="driverTrainstate">是否培训</label>
												<select name="driverTrainstate" id="driverTrainstate" class="form-control" data-search="true">
													<option value="">--请选择--</option>
													<c:forEach items="${DRIVER_TRAINSTATE }" var="m">
														<option value="${m.key }" <c:if test="${params.driverTrainstate eq m.key }">selected="selected"</c:if>>${m.value }</option>
													</c:forEach>
												</select>
											</div>
										</div>
										...
										<div class="col-sm-4">
											<div class="form-group">
												<label class="control-label" for="driverBeizhu">标题</label>
												<input type="text" id="driverBeizhu" name="driverBeizhu" placeholder="标题" class="form-control" value="${params.driverBeizhu }" data-search="true" />
											</div>
										</div>
										
										<div class="col-sm-4">
											<div class="form-group">
												<label class="control-label" for="driverTel">手机号码</label>
										...
										<div class="ibox-title">
											...
											<div class="ibox-tools">
												...
												<ul class="dropdown-menu dropdown-user">
												    <li><a href="../list/190.html?mid=19&driverBeizhu=${params.driverBeizhu }&driverTel=${params.driverTel }&driverTrainstate=${params.driverTrainstate}">导出</a></li>
												</ul>
												<script type="text/javascript">
													$(function() {
											...
											<table class="footable table table-stripped toggle-arrow-tiny">
												<thead>
													<tr>
														...
														<th data-sort-ignore="true">是否培训</th>
														<th data-sort-ignore="true">培训标题</th>
													</tr>
												</thead>
												<tbody>
													<c:forEach items="${models }" var="m">
														<tr>
															...
															<td>															
																<c:if test="${ m.driverTrainstate eq 0}">未培训</c:if>
																<c:if test="${ m.driverTrainstate eq 1}">已培训</c:if>
																<c:if test="${empty m.driverTrainstate }">-</c:if> 																														
															</td>
