							...
							<div class="ibox">
								...
								<div class="ibox-content m-b-sm border-bottom">
									...
									<div class="row">
										...
										<div class="col-sm-4">
											<div class="form-group">
												<label class="control-label" for="title">费用发生日期自</label>
												<div class="input-group date">
													<span class="input-group-addon"><i
														class="fa fa-calendar"></i></span> <input type="text"
														name="ge_date" id="ge_date" placeholder="费用发生日期自"
														class="form-control"
										...
										<div class="ibox-title">
											...
											<div class="ibox-tools">
												...
												<ul class="dropdown-menu dropdown-user">
													<li><a href="../list/127.html?mid=16&driverName=${params.driverName }&driverId=${params.driverId }&driverCarnum=${params.driverCarnum }&ge_date=${params.ge_date }&le_date=${params.le_date }">导出</a></li>
												</ul>
												<script type="text/javascript">
													$(function() {
											...
											<table class="footable table table-stripped toggle-arrow-tiny">
												<thead>
													<tr>
														...
														<th data-sort-ignore="true">费用承担</th>
														<th data-sort-ignore="true">费用目的</th>
														<th data-sort-ignore="true">费用类型</th>
														<th data-sort-ignore="true">费用</th>
												...
												<tbody>
													...
													<c:forEach items="${models }" var="m">
														<tr>
														<c:if test="${not empty m.driverRmb }">
															<td>
																${m.driverTel }
