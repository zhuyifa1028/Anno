					...
					<div class="col-lg-12 animated fadeInRight">
						<div class="ibox float-e-margins">
							...
							<div class="ibox-content">
								<form class="form" action="${admin }/rental/edit/26" method="post" novalidate="novalidate">
									<c:if test="${not empty model }">
										<input type="hidden" name="_id" value="${model.id }" />
									</c:if>
															
							<%-- 	<input type="hidden" name="sequence" value="${model.areaSequence}" />   --%>
									
									<%-- 	
									<div class="form-group" role="form">
										<label>省</label>
										<input type="text" name="sequence" placeholder="请输入省" class="form-control" value="${model.programaSequence }" />
									</div>
									<div class="form-group" role="form">
										<label>市</label>
										<input type="text" name="sequence" placeholder="请输入市" class="form-control" value="${model.programaSequence }" />
									</div> --%>
