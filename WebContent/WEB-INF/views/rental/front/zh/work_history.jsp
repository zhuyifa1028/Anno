...
<form class="m-t-150 mui-form-group" method="post" novalidate="novalidate">
	<div class="daily-history-fixed h-80 bg-ffffff">
		...
		<button id="submit" class="mui-btn f-s-16 mui-btn-link mui-pull-right h-80" type="button">确认</button>
	</div>
	<header class="mui-bar mui-bar-nav p-rl-30 h-74 bg-2cad6e">
		<h1 class="mui-title f-s-16 l-h-d-74 ft-ffffff">加班和费用</h1>
		<a href="../en/work_history.html" class="mui-btn f-s-14 mui-btn-link mui-pull-right mui-en-zh">En</a>
	</header>
			...
			<div class="mui-slider-group">
				<div id="not" class="mui-slider-item mui-control-content mui-active">
					<div class="table bg-ffffff f-s-14 ft-999999 t-a-c">
						...
						<div class="table-cell h-80 v-a-m">日期</div>
						<div class="table-cell h-80 v-a-m">加班时长</div>
						<div class="table-cell h-80 v-a-m p-r-5">加班费用</div>
						<div class="table-cell h-80 v-a-m p-l-5">代支费用</div>
					</div>
					    ...
					    <div class="mui-scroll">
						   <div class="table-list f-s-12">
							...
							<div class="m-t-40 p-l-30 f-s-12">
								<div class="ft-999999 m-t-10">工作日加班</div>
								<div class="ft-e93939 m-t-10">双休日加班</div>
								<div class="ft-e9c239 m-t-10">节假日加班</div>
							</div>
						</div>
					</div>
		...
		$(function() {
			...
			$('.mui-form-group').on('tap', '#submit', function() {
	            setTimeout(function() {
					...
					$.post('../zh/work_history', {chk_value: chk_value}, function(data) {
						if(data.succeed == true) {
							window.location.href = '../zh/work_history.html';
						} else {
