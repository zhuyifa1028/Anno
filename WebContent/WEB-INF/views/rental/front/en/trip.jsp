...
<body>
	<header class="mui-bar mui-bar-nav p-rl-30 h-74 bg-2cad6e">
	    <a class="mui-btn f-s-14 mui-btn-link mui-pull-right"
				style="float: left;" href="index.html">Home</a>
		<h1 class="mui-title f-s-16 l-h-d-74 ft-ffffff">Message Generated</h1>
		<a href="../zh/trip.html?servicedate=${param.servicedate}&servicetime=${param.servicetime}&id=${param.id}&servicecontent=${param.servicecontent}&fucity=${param.fucity}&futrain=${param.futrain}" class="mui-btn f-s-14 mui-btn-link mui-pull-right mui-en-zh">中</a>
	</header>
	<div class="mui-content">
		...
		<div class="m-t-40 f-s-12 ft-999999 t-a-c l-h-17">Please long press to copy the content<br />and paste it on your personal Wechat</div>
	</div>
</body>
</html>