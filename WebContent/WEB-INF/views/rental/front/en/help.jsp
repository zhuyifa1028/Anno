...
<body>
	<header class="mui-bar mui-bar-nav p-rl-30 h-74 bg-2cad6e">
		<h1 class="mui-title f-s-16 l-h-d-74 ft-ffffff">Help Center</h1>
		<a href="../zh/help.html" class="mui-btn f-s-14 mui-btn-link mui-pull-right mui-en-zh">中</a>
	</header>
	<div class="mui-content">
		<div class="m-t-45 p-rl-45">
			<c:forEach items="${models }" var="m">
			<c:if test="${m.recordIsDisplay eq 0}">
			<c:if test="${m.recordLanguage eq 1}">
