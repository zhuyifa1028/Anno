...
<body>
	<header class="mui-bar mui-bar-nav p-rl-30 h-74 bg-2cad6e">
		<h1 class="mui-title f-s-16 l-h-d-74 ft-ffffff">Share</h1>
		<a href="../zh/share.html" class="mui-btn f-s-14 mui-btn-link mui-pull-right mui-en-zh">中</a>
	</header>
	<div class="mui-content">
		<img class="m-t-110 m-lr-auto d-b w-p-32" src="${files }/images/login.png" alt="" />
		<div class="m-t-100 f-s-14 ft-333333 t-a-c">Share Arval official account on Wechat</div>
		<div class="p-rl-45">
			<button class="mui-btn mui-btn-block m-t-150 ft-ffffff f-s-16 bg-2cad6e">Submit</button>
		</div>
	</div>
	<div class="mui-share-mark hide">
		<div class="w-p-100 h-p-100 bg-000000"></div>
		<img src="${files }/images/share_en_title.png"/>
	</div>
