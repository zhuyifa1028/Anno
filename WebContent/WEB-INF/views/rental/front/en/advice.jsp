...
<body>
	<header class="mui-bar mui-bar-nav p-rl-30 h-74 bg-2cad6e">
		<h1 class="mui-title f-s-16 l-h-d-74 ft-ffffff">Complaints</h1>
		<a href="../zh/advice.html?jian=${param.jian }" class="mui-btn f-s-14 mui-btn-link mui-pull-right mui-en-zh">中</a>
	</header>
	<div class="mui-content">
		<div class="p-t-40 p-rl-45">
			<div class="ft-999999 f-s-14">Dear customer:</div>
			<p class="ft-999999 f-s-14">To improve our customer satisfaction, please do not hesitate to send us your comments.</p>
			<div class="ft-999999 f-s-14">Thank you!</div>
			<div class="m-t-40">
				<form class="mui-form-group" method="post">
					...
					<div class="m-t-30 mui-select mui-select-boult mui-select-bear">
						<span class="ft-999999 f-s-16" name="leixing">Choose the category</span>
						<input type="hidden" name="category" />
					</div>
					<div class="m-t-30 mui-select mui-select-boult mui-select-business">
						<span class="ft-999999 f-s-16" name="neirong">Choose the sub-category</span>
						<input type="hidden" name="content" />
					</div>
					<textarea class="mui-star-leave m-t-30 f-s-16 ft-333333 p-rl-40 p-tb-25 bg-transparent" placeholder="Leave the message" name="tecontent"></textarea>
					<button class="mui-btn mui-btn-block m-t-60 ft-ffffff f-s-16 bg-2cad6e" type="submit">Confirm</button>
				</form>
			</div>
		</div>
	</div>
	<script type="text/javascript" src="${files }/js/index_en.js"></script>
		...
		$(function() {
			...
			$('.mui-form-group').on('tap', '.mui-btn', function() {
				setTimeout(function() {
	                ...
	                $.post('../en/advice', {tel:_usertel,name:_username,driverid:_drivertel,complsort: _complsort, complsorts: _complsorts,compldetails:_compldetails}, function(data) {
