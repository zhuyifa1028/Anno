...
import com.product.bean.ExcelBean;


/**
 * excel读写工具类 Excel 导入到mysql Created by CR7 on 2017-9-12
 * 
 * @author ymc
 *
 */
            ...
            for (int i = 0; i < ems.size(); i++) {  
                ...
                if (rtn != null) {  
                    if (rtn instanceof Date) {  
                        value = DateUtils.getDateFormat((Date)rtn, DateUtils.SHORT_DATE_FORMAT);  
